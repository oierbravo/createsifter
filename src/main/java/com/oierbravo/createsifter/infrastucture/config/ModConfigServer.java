...
public class ModConfigServer extends ConfigBase {
    public final SifterConfigs sifter = nested(0, SifterConfigs::new, "Sifter Configs");
    public final BrassSifterConfigs brassSifter = nested(0, BrassSifterConfigs::new, "Brass Sifter Configs");
    public final MeshConfigs mesh = nested(0, MeshConfigs::new, "Mesh Configs");
